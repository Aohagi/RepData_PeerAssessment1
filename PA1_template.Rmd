...
I have already downloaded the data and it's in my working directory `r getwd()`. Now, I load the data and do some cleaning like changing the date variable to the date format that R recognises. 
...
The mean  and median total number of steps taken per day is 10766.19 and `r med` respectively.
...
```{r imputed data histogram of total daily steps}
